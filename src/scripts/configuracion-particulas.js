...
/* To load a config file (particulas.json) you need to host this demo (MAMP/WAMP/local)... */
/*
particlesJS.load('particles-js', 'particulas.json', function() {
  console.log('particulas.js loaded - callback');
});
*/
